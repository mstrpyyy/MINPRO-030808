...
export default function Register() {
  return (
    <div className='bg-xwhite min-h-[calc(100vh-64px)] flex flex-col items-center'>
      <h1 className='text-xorange text-4xl md:text-5xl font-bold mt-7 mb-4 sm:mt-28 text-center text-balance mx-10'>Choose your account type.</h1>
      ...
      <div className='flex gap-5 md:gap-10 flex-wrap justify-center mx-7'>
        <Link href={'/signup/user'} className='flex flex-col justify-center items-center w-60 h-72 md:w-80 md:h-96  md:hover:drop-shadow-[0_0_7px_rgba(0,0,0,0.3)] transition-all drop-shadow-[0_0_4px_rgba(0,0,0,0.3)] rounded-xl bg-white'>
          ...
          <h3 className='text-xorange font-normal text-2xl md:text-4xl pb-2'>Consumer</h3>
        ...
        <h3 className='text-xorange font-normal text-2xl md:text-4xl pb-2'>Organizer</h3>
