...
export default function Page() {
  ...
  return (
    <div className='sm:p-7 p-2 w-full'>
      ...
      <div className='flex max-md:flex-col my-7 bg-xdark w-full p-10 text-xgreen1 text-3xl max-md:text-2xl max-sm:text-xl items-center rounded-2xl shadow-[0_0_5px_rgba(0,0,0,0.3)]'>
        ...
        <div className='flex justify-evenly w-full max-md:flex-col '>
          ...
          <div className='flex flex-col justify-between items-center grow max-w-[600px]'>
            <div className='flex items-center max-md:text-xl max-md:font-medium text-3xl text-xgreen1 gap-1'>
              <RiImageEditFill />
              <p>Profile Picture</p>
            </div>
          ...
          <div className='flex flex-col grow max-md:mt-10 max-w-[600px]'>
            <div className='flex items-center justify-center max-md:text-xl max-md:font-medium gap-1 text-3xl text-xgreen1 max-md:py-5 sm:mb-16 max-md:border-t-2 max-md:border-zinc-300'>
              <FaClipboardUser />
              <p>Edit Profile</p>
            </div>
            ...
            <div className='flex justify-between border-b-2 border-zinc-300 shrink sm:p-2 py-2'>
              <div className='flex justify-between items-start w-full flex-col'>
                ...
                <p className='text-white text-lg sm:text-xl md:text-2xl sm:pr-5 truncate'>{isClient ?account?.name : ''}</p>
              </div>
              <button onClick={openModalName} className='text-sm md:text-lg text-xgreen1 font-bold active:outline-none focus:outline-none'>change</button>
              <ChangeNameModal />
            </div>
            ...
            <div className='flex justify-between border-b-2 border-zinc-300 shrink sm:p-2 py-2'>
              <div className='flex justify-between items-start w-full flex-col'>
                ...
                <p className='text-white text-lg sm:text-xl md:text-2xl sm:pr-5 truncate'>{isClient? account?.email : ''}</p>
              </div>
              <button onClick={openModalEmail} className='text-sm md:text-lg text-xgreen1 font-bold'>change</button>
              <ChangeEmailModal />
            </div>
            ...
            <div className='flex justify-between border-b-2 border-zinc-300 shrink sm:p-2 py-2'>
              <div className='flex justify-between items-start w-full flex-col'>
                ...
                <p className='text-white text-lg sm:text-xl md:text-2xl sm:pr-5 truncate'>••••••••••••</p>
              </div>
              <button onClick={openModalPassword} className='text-sm md:text-lg text-xgreen1 font-bold'>change</button>
              <ChangePasswordModal />
            </div>
