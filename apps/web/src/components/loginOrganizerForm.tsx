                            ...
                            <Form className='flex flex-col items-center w-full gap-7'>
                                    ...
                                    <div className='w-full'>
                                        <div  className='flex flex-col'>                                            
                                            ...
                                            <Field type="password" placeholder="Organizer password" name="password" className="bg-zinc-200 text-xl text-xblack border-b-[1px] border-xmetal focus:outline-none placeholder:text-zinc-400" />
                                        </div>
