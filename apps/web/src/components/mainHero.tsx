    ...
    return (
        <div id="1" className="relative w-full md:my-4">
            <div className="absolute inset-0 overflow-x-hidden">
                <Image src="/images/maincover.jpg" width={3024} height={2005} alt='foto' className={`w-full h-[500px] object-cover md:rounded-3xl z-0`} />
            </div>
            <div className="relative z-[1] flex flex-col items-center justify-center h-[500px] md:rounded-3xl">
